...
class LCPO_Runner:
    def __init__(self, config: ConfigLoader, model_name: str, dataset: str, is_truth : str,
                 ...
                 initial_tokens=None, is_extract:str="true"):
        ...
        self.max_concurrent_requests = 15  # 建议 5~15，根据模型和账户配额灵活设置
...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="o4", help="Project name")
    # train
    parser.add_argument("--dataset", type=str, default="bbh", help="Project name")
    ...
    parser.add_argument("--init_right", type=int, default=4000, help="初试token_list边界右值")
    parser.add_argument("--init_step", type=int, default=400, help="初试token_list边界步长")
...
def main():
    ...
    try:
        ...
        runner = LCPO_Runner(config=config, model_name=args.model_name, dataset=args.dataset,
                             sample_k=args.sample_k, n_steps=args.n_steps,
